...
public class ProgramStepStateMonitorForNewTests extends AbstractDebuggerLauncher{
     ...
     */
    public ProgramStepStateMonitorForNewTests(JavaProject project, LogLevel logLevel, long timeoutPerTest,
    ...
    protected void processTestEnd(BreakpointEvent breakpointEvent) {
        ...
        //这一句会修改MethodDeclarationInfoCenter
