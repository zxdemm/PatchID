...
public class Alphabet {
   ...
   {
  boolean result64711720;
  hk.polyu.comp.jaid.tester.Tester.startMethodToMonitor();
  if (hk.polyu.comp.jaid.tester.Tester.isMonitorMode && hk.polyu.comp.jaid.tester.Tester.isExecutingMTF) {
    throw new hk.polyu.comp.jaid.tester.Tester.MTFIsMonitoredException();
  }
  hk.polyu.comp.jaid.tester.Tester.isExecutingMTF=true;
  boolean hasException__JAID_VAR;
  hasException__JAID_VAR=false;
  String exceptionClassType__JAID_VAR;
  exceptionClassType__JAID_VAR=null;
  try {
    try {
      return result64711720=(this.vowel);
    }
 catch (    RuntimeException t__JAID_VAR) {
      hasException__JAID_VAR=true;
      exceptionClassType__JAID_VAR=t__JAID_VAR.toString();
      throw t__JAID_VAR;
    }
catch (    Error t__JAID_VAR) {
      hasException__JAID_VAR=true;
      exceptionClassType__JAID_VAR=t__JAID_VAR.toString();
      throw t__JAID_VAR;
    }
    ...
    hk.polyu.comp.jaid.tester.Tester.isExecutingMTF=false;
    hk.polyu.comp.jaid.tester.Tester.endMethodToMonitor();
  }
}
